...
router.post(
  "/custom",
  authMiddleware,
  mockInterviewController.createCustomQuestions
);
router.get(
  "/custom",
  authMiddleware,
  mockInterviewController.getCustomQuestions
);
router.delete(
  "/custom/:questionId",
  authMiddleware,
  mockInterviewController.deleteCustomQuestions
);
...
router.post(
  "/saveResults",
  authMiddleware,
  mockInterviewController.saveInterviewResults
);
router.get(
  "/getResults",
  authMiddleware,
...
router.get(
  "/getResultDetails/:sequence",
  authMiddleware,
  mockInterviewController.getInterviewResultDetails
);
router.delete(
  "/detail/:sequence",
  authMiddleware,
  mockInterviewController.deleteInterviewResult
);
